...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/10/27 20:54:23 by vrabaib           #+#    #+#             */
/*   Updated: 2019/10/27 20:54:25 by vrabaib          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int Player::getAmmoAmt( void ) {
    return this->_ammoAmt;
}

Bullet* Player::getAmmo( void ) {
    return this->_ammo;
}

void Player::shoot( void ) {
    _ammoIndex += 1;
    if ( _ammoIndex == _ammoAmt )
        _ammoIndex = 0;
